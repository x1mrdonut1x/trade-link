...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from '@tradelink/ui/components/sheet';
import { Skeleton } from '@tradelink/ui/components/skeleton';
...
function SidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
  return (
    <main
      ...
      className={cn(
        'bg-background relative flex w-full flex-1 flex-col pb-2 sm:pb-6 ',
